...
function twcm_get_options()
{
    ...
    if ( !$saved_options['default_card_type'] ) {
        $saved_options['default_card_type'] = "summary";
    }
...
function twcm_options_page()
{
    ...
    if ( isset( $_POST['save_options'] ) ) {
        $options = array(
                'site_twitter_username'          => isset( $_POST['site_twitter_username'] ) ? sanitize_text_field( trim( $_POST['site_twitter_username'] ) ) : '',
                'use_authors_twitter_account'    => isset( $_POST['use_authors_twitter_account'] ) ? intval( $_POST['use_authors_twitter_account'] ) : '', 
                'use_image_from'                 => isset( $_POST['use_image_from'] ) ? sanitize_text_field( $_POST['use_image_from'] ) : '', 
                'image_custom_field'             => isset( $_POST['image_custom_field'] ) ? sanitize_text_field( trim( $_POST['image_custom_field'] ) ) : '',
                'default_image'                  => (trim($_POST['default_image'])=='Link to Default Image')? '' : sanitize_text_field( trim( $_POST['default_image'] ) ),
                ...
                'default_card_type'              => isset( $_POST['default_card_type'] ) ? sanitize_text_field( $_POST['default_card_type'] ) : '', 
                'use_default_card_type_sitewide' => isset( $_POST['use_default_card_type_sitewide'] ) ? sanitize_text_field( $_POST['use_default_card_type_sitewide'] ) : ''
        );  
